...
**Generated:** 2026-04-24 09:30:13 UTC
...
| **Validation ID** | `9c47951a-cd55-4b6e-8a33-64fbc32d9eb1` |
...
| :--- | :---: | :---: | :---: | :--- |
| Tools/list | 3 | HTTP 200 | 69.1 ms | ✅ Listed<br/>Call ✅ |
| Resources/list | 0 | HTTP 200 | 68.2 ms | ✅ Listed |
| Prompts/list | 0 | HTTP 200 | 87.0 ms | ✅ Listed |
...
**Status:** ✅ Passed
**Execution Time:** 69.12ms
---

### Tool: `microsoft_docs_search`

**Status:** ✅ Passed
**Execution Time:** 901.75ms
...
| :--- | :--- | :--- |
| **Avg Latency** | 76.56ms | 🚀 Excellent |
| **P95 Latency** | 84.00ms | - |
| **Throughput** | 13.03 req/sec | - |
