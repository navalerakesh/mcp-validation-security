...
.panel--tone-success { border-color: var(--line); background: linear-gradient(180deg, rgba(255,255,255,0.99), rgba(246,248,251,0.98)); }
...
.panel--tone-info { border-color: var(--line); background: linear-gradient(180deg, rgba(255,255,255,0.99), rgba(246,248,251,0.98)); }
.panel--tone-neutral { border-color: var(--line); background: linear-gradient(180deg, rgba(255,255,255,0.99), rgba(246,248,251,0.98)); }
.status-chip,
.tone-chip {
    display: inline-flex;
    align-items: center;
...
.report-note--success { border-left-color: var(--line-strong); }
.decision-brief--tone-warning,
.report-note--warning,
.status-callout--warning { border-left-color: var(--tone-warning); }
.decision-brief--tone-danger,
.report-note--danger { border-left-color: var(--tone-danger); }
.decision-brief--tone-info,
.report-note--info { border-left-color: var(--line-strong); }
.decision-brief--tone-neutral,
.report-note--neutral { border-left-color: var(--line-strong); }
.decision-title {
    margin: 8px 0 8px;
    font-size: 1.28rem;
    color: var(--text-strong);
...
.ledger-entry--success { border-left-color: var(--line-strong); }
.ledger-entry--warning { border-left-color: var(--tone-warning); }
.ledger-entry--danger { border-left-color: var(--tone-danger); }
.ledger-entry--info { border-left-color: var(--line-strong); }
.ledger-entry--neutral { border-left-color: var(--line-strong); }
.ledger-rail {
    display: grid;
    align-content: start;
    gap: 8px;
...
.auth-scenario--success { border-left-color: var(--line-strong); }
.auth-scenario--warning { border-left-color: var(--tone-warning); }
.auth-scenario--danger { border-left-color: var(--tone-danger); }
.auth-scenario--info { border-left-color: var(--line-strong); }
.auth-scenario--neutral { border-left-color: var(--line-strong); }
...
.score-pill--success { border-color: var(--line); }
...
.score-pill--info { border-color: var(--line); }
.score-pill--neutral { border-color: var(--line); }
.score-pill__eyebrow {
    font-size: 0.72rem;
    letter-spacing: 0.12em;
    text-transform: uppercase;
...
.metric-card--success { border-color: var(--line); }
...
.metric-card--info { border-color: var(--line); }
.metric-card--neutral { border-color: var(--line); }
.metric-eyebrow {
    font-size: 0.72rem;
    letter-spacing: 0.14em;
    text-transform: uppercase;
...
.distribution-card--success { border-color: var(--line); }
...
.distribution-card--info { border-color: var(--line); }
.distribution-card--neutral { border-color: var(--line); }
